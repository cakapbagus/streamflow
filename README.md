...
[![Version](https://img.shields.io/badge/version-2.2.0-blue.svg)](https://github.com/cakapbagus/streamflow/releases)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/cakapbagus/streamflow/blob/main/LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/cakapbagus/streamflow/blob/main/CONTRIBUTING.md)
[![GitHub Stars](https://img.shields.io/github/stars/cakapbagus/streamflow?style=social)](https://github.com/cakapbagus/streamflow/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/cakapbagus/streamflow?style=social)](https://github.com/cakapbagus/streamflow/network/members)
...
[🚀 Installation](#-quick-installation) • [📖 Documentation](#-manual-installation) • [🐳 Docker](#-docker-deployment) • [🪛 Troubleshooting](#-troubleshooting) • [💬 Community](https://github.com/cakapbagus/streamflow/discussions)
...
```bash
curl -o install.sh https://raw.githubusercontent.com/cakapbagus/streamflow/main/install.sh && chmod +x install.sh && ./install.sh
```
...
Clone repository:
```bash
git clone https://github.com/cakapbagus/streamflow
```
...
[![Contributors](https://contrib.rocks/image?repo=cakapbagus/streamflow)](https://github.com/cakapbagus/streamflow/graphs/contributors)

## 📄 License

[![MIT License](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/cakapbagus/streamflow/blob/main/LICENSE)

---
© 2026 - [Bang Tutorial](https://youtube.com/cakapbagus)
